...
const NAV: NavItem[] = [
  { id: "scan", label: "Scan", icon: Layers, description: "Scout + Wire" },
  ...
  { id: "certify", label: "Certify", icon: ShieldCheck, description: "Conformance + Receipt" },
  { id: "plan", label: "Plan", icon: Sparkles, description: "Agent Action Cards" },
  { id: "topology", label: "Topology", icon: Network, description: "MCP Tool Graph" },
  { id: "doctor", label: "Doctor", icon: Stethoscope, description: "Environment Check" },
              ...
              <button
                ...
                className={cn(
                  ...
                  isActive
                    ...
                    : "text-monolith-muted hover:text-cyber-chrome",
                )}
              >
                {isActive && (
                  <motion.div
                ...
                <AnimatePresence mode="wait">
                  {open && (
                    ...
                    >
                      ...
                      <span className="text-[8px] text-monolith-muted mt-0.5 whitespace-nowrap">
                        {item.description}
                      </span>
                    </motion.div>
                  )}
          ...
          {NAV.map((item) => {
            ...
            return (
              ...
              >
                ...
                <item.icon size={16} />
                <span className="text-[7px] font-mono uppercase tracking-tight">
                  {item.label}
                </span>
              </button>
            );
